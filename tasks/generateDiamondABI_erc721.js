...
const basePath = "/contracts/FakeGotchisNFTDiamond/facets/";
...
task(
  ...
  fs.writeFileSync("./diamondABI/diamond_erc721.json", abi);
  console.log("ABI written to diamondABI/diamond_erc721.json");
});
