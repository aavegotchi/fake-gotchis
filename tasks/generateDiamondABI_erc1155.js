...
const basePath = "/contracts/FakeGotchisCardDiamond/facets/";
...
task(
  ...
  for (const file of files) {
    ...
    if (["AppStorage.json", "AppStorageCard.json"].includes(jsonFile))
  ...
  fs.writeFileSync("./diamondABI/diamond_erc1155.json", abi);
  console.log("ABI written to diamondABI/diamond_erc1155.json");
});
